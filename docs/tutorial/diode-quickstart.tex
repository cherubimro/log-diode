...
within an optical class the maximum launch power is set at or below the
maximum receive power, so a compliant transmitter cannot overload a compliant
receiver. If instead you use a long-range converter or SFP --- built to drive
