...
Within one optical class this is designed out: the standard sets the maximum
launch power at or below the maximum receive power (\dbm{-14} against
\dbm{-14} for 100BASE-FX, \dbm{-4} against \dbm{0} for 1000BASE-SX, \dbm{-3}
against \dbm{-3} for 1000BASE-LX), so two matched short-reach converters
cannot overload each other even over a metre of fiber. Three matched
converters on a bench need no attenuation.
