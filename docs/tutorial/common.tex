...
%%
%% common.tex -- shared preamble for the log-diode tutorial documents.
...
\fancyfoot[C]{\footnotesize log-diode tutorial --- CC BY 4.0}
...
\lstdefinestyle{shell}{
  ...
  morekeywords={ip,nft,iptables,ip6tables,pfctl,sysctl,systemctl,tcpdump,arp,
                ethtool,openssl,ld_amp,ld_deamp,rsyslogd,hping3,arping,nc,socat},
}
\lstdefinestyle{conf}{
  language=,
  morecomment=[l]{\#},
...
\newcommand{\amp}{\prog{ld\_amp}}
\newcommand{\deamp}{\prog{ld\_deamp}}
\newcommand{\lowside}{\textsc{low}}
\newcommand{\highside}{\textsc{high}}
\newcommand{\nm}[1]{#1\,nm}
